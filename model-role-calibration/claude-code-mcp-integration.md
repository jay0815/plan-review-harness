...
```bash
node model-role-calibration/scripts/plan-review-mcp.js \
...
claude mcp add --scope user plan-review-harness -- \
  node /ABSOLUTE/PATH/plan-review-harness/model-role-calibration/scripts/plan-review-mcp.js \
  --settings-dir /ABSOLUTE/PATH/TO/claude-settings
```
...
```json
{
  "mcpServers": {
    "plan-review-harness": {
      ...
      "command": "node",
      "args": [
        "/ABSOLUTE/PATH/plan-review-harness/model-role-calibration/scripts/plan-review-mcp.js",
        "--settings-dir",
