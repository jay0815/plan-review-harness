...
```bash
node --import tsx model-role-calibration/scripts/mcp/plan-review-mcp.ts \
...
claude mcp add --scope user plan-review-harness -- \
  node --import tsx /ABSOLUTE/PATH/plan-review-harness/model-role-calibration/scripts/mcp/plan-review-mcp.ts \
  --settings-dir /ABSOLUTE/PATH/TO/claude-settings
```
  ...
  "mcpServers": {
    "plan-review-harness": {
      ...
      "args": [
        "--import",
        "tsx",
        "/ABSOLUTE/PATH/plan-review-harness/model-role-calibration/scripts/mcp/plan-review-mcp.ts",
        "--settings-dir",
