...
function main() {
  ...
  try {
    ...
    assert(fs.existsSync(path.join(result.packageDir, 'mcp', 'scripts', 'inspect-workspace-run.js')))
    assert(fs.existsSync(path.join(result.packageDir, 'mcp', 'scripts', 'verify-workspace-review-run.js')))
    assert(fs.existsSync(path.join(result.packageDir, 'mcp', 'scripts', 'doctor-workspace-review-run.js')))
    assert(fs.existsSync(path.join(result.packageDir, 'mcp', 'scripts', 'backfill-workspace-run-manifest.js')))
    assert(fs.existsSync(path.join(result.packageDir, 'mcp', 'scripts', 'retry-workspace-review-stage.js')))
    assert(fs.existsSync(path.join(result.packageDir, 'mcp', 'scripts', 'json-validator-mcp.js')))
    ...
    assert(fs.existsSync(path.join(result.packageDir, 'mcp', 'scripts', 'plan-authoring-lint.js')))
    assert(fs.existsSync(path.join(result.packageDir, 'mcp', 'scripts', 'workspace-review-manifest.js')))
...
`,
    ...
    assert.equal(status.role_route_source.route_file, 'model-role-calibration/default-role-routes.json')
