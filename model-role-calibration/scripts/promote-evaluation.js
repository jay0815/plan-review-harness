...
const { ROOT, parseArgs, requireArg, assertSafeCaseId, assertProbe, loadConfig, parseJsonFile, timestamp, writeFileNew, } = require('./lib');
const { parseList, hashText, evaluationPaths, validateEvaluationScore } = require('./evaluation-lib');
function main() {
