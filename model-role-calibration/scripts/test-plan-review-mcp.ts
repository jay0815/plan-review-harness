...
async function main() {
  ...
  try {
    ...
    const synthesisSchema = JSON.parse(
      fs.readFileSync(path.join(__dirname, '..', 'schemas', 'synthesis-output.schema.json'), 'utf8'),
    )
    const factCheckSchema = JSON.parse(
      fs.readFileSync(path.join(__dirname, '..', 'schemas', 'fact-check-output.schema.json'), 'utf8'),
    )
    ...
    const executionSchema = JSON.parse(
      fs.readFileSync(path.join(__dirname, '..', 'schemas', 'execution-output.schema.json'), 'utf8'),
    )
