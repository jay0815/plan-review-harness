...
const SCRIPT = 'model-role-calibration/scripts/cli/v2-calibration-plan.ts'
const RUN_CALIBRATION = 'model-role-calibration/scripts/cli/run-calibration.ts'
const SCORE_OUTPUT = 'model-role-calibration/scripts/cli/score-output.ts'
const SUMMARIZE_RESULTS = 'model-role-calibration/scripts/cli/summarize-results.ts'
...
function _rel(file: string): string {
