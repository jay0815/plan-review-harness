...
import { ROOT, isMainScript, parseArgs } from '../lib/lib.js'
...
export const RUNTIME_SCRIPT_SOURCES = [
  'scripts/lib/lib.ts',
  'scripts/lib/workspace-review-types.ts',
  'scripts/lib/workspace-review-config.ts',
  'scripts/lib/workspace-review-lib.ts',
  'scripts/lib/workspace-review-manifest.ts',
  'scripts/cli/run-model.ts',
  'scripts/mcp/json-validator-mcp.ts',
  'scripts/workspace/plan-authoring-lint.ts',
  'scripts/workspace/run-workspace-review.ts',
  'scripts/workspace/retry-workspace-review-stage.ts',
  'scripts/mcp/plan-review-mcp.ts',
  'scripts/workspace/inspect-workspace-run.ts',
  'scripts/workspace/verify-workspace-review-run.ts',
  'scripts/workspace/doctor-workspace-review-run.ts',
  'scripts/workspace/backfill-workspace-run-manifest.ts',
]
...
\`\`\`bash
node ~/.claude/plan-review-harness/mcp/scripts/workspace/verify-workspace-review-run.js \\
  --run-id <run-id>
\`\`\`
...
\`\`\`bash
node ~/.claude/plan-review-harness/mcp/scripts/workspace/doctor-workspace-review-run.js \\
  --run-id <run-id>
\`\`\`
...
\`\`\`bash
node ~/.claude/plan-review-harness/mcp/scripts/workspace/backfill-workspace-run-manifest.js \\
  --run-id <run-id>
\`\`\`
...
function createArchive(outputDir: string, packageDir: string): string {
